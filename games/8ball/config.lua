...
Config.BALL_LINEAR_DAMPING = 0.7
Config.BALL_ANGULAR_DAMPING = 1
Config.BALL_VELOCITY_LIMIT = 4
Config.BALL_DAMPING_VALUE = 300 * 300       -- speed^2 threshold for increased damping
Config.BALL_DOUBLE_DAMPING_VALUE = 150 * 150 -- speed^2 threshold for double damping
Config.BALL_LINEAR_INCREASE_MULTIPLE = 0.7
Config.BALL_LINEAR_INCREASE_DOUBLE_MULTIPLE = 1.0
Config.INCREASE_VELOCITY_TIME = 1           -- seconds after shot before damping increases
